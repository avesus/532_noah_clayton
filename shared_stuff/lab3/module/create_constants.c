//////////////////////////////////////////////////////////////////////
// File to store some useful CPU/OS info as constants. Will store number of
// threads, TEMP_PATH, TEMP_PATH_TYPE and cache line info. TEMP_PATH info is
// related to temp_barrier code.
...
main(int32_t argc, char * argv[]) {
    ...
    if ((result = createTempBasePath(transfer_path)) == NOT_FOUND) {
        PRINT(ERROR_VERBOSE, "Couldn't find temperature path\n");
    }
