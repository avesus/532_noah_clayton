...
#define INT_MAX (~(1<<31))
#define MAX_TIME_ARRAYS 32
#define DEFAULT_MIN 128 //this is unused and entirely for astetic
			//purposes
#define DEFAULT_MIN_LOG_MINUS_ONE 6
